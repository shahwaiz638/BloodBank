...
public class SentEmailActivity extends AppCompatActivity {
    ...
    private void getIdOfUsers() {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("email").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId())
        {
            case android.R.id.home:
                Intent intent = new Intent(SentEmailActivity.this, MainActivity.class);
                finish();
